ShaguPlates_translation["zhCN"] = {
  ...
  ["Ammo Counter"] = "弹药数量",
  ["A new installation of |cff33ffccpf|rUI ships with 4 prebuilt design profiles. Click below if you wish to load one of these profiles."] = "ShaguPlates的新安装自带4以下四种预设风格.点击下方可选择其一",
  ...
  ["Disable Module"] = "禁用",
  ["Disable ShaguPlates Unit Frames"] = "禁用头像框架",
