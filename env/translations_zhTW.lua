ShaguPlates_translation["zhTW"] = {
  ...
  ["Ammo Counter"] = "彈藥數量",
  ["A new installation of |cff33ffccpf|rUI ships with 4 prebuilt design profiles. Click below if you wish to load one of these profiles."] = "ShaguPlates的安裝內建有四種風格.點選以下讀取其一",
  ...
  ["Disable Module"] = "禁用",
  ["Disable ShaguPlates Unit Frames"] = "禁用頭像框架",
