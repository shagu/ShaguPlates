...
--[[ libtotem ]]--
-- A ShaguPlates library that tries to emulate the TotemAPI that was introduced in Patch 2.4.
...
if ShaguPlates.api.libtotem then return end
...
ShaguPlates.api.libtotem = libtotem
